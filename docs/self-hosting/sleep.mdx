...
- **Supply a wildcard.** `--tls custom` with a certificate for `*.<domain>` issues nothing per
  hostname, so no name is published, nothing arrives to find it, and the idle timer runs to the
  end. See [TLS and what your domain costs you](/self-hosting/install#tls-and-what-your-domain-costs-you),
