...
- **A request on any lane.** HTTP, Postgres, Redis, MongoDB or MySQL. The connection is held while
  the container starts, for up to 60 seconds, plus up to 38 seconds of readiness retries after
...
| `INSTA_OSS_SCHEDULER` | 1 | set to 0 to turn sleeping off entirely |
