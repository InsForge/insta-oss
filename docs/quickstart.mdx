...
From step 3 on, everything works two ways: hand your agent a prompt, or run the CLI yourself. Where both are shown, the prompt comes first and the CLI sits on the second tab.
