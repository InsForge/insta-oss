...
- **Deploying an app.** Add a database and a compute service, `insta deploy .`, get a URL. Databases scale to zero and containers sleep when idle, so an idle project costs nothing.
