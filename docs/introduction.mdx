---
title: "Introduction"
description: "What InstaCloud is, what a project and a branch are, and where to start."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Set up your agent" icon="robot" href="/agent-setup">
    Claude Code, Cursor, Codex — one command.
  </Card>
  <Card title="Self-host" icon="server" href="/self-host-quickstart">
...
<CardGroup cols={2}>
  <Card title="Branchable environments" icon="code-branch" href="/concepts/branches">
  ...
  <Card title="One credential seam" icon="key" href="/concepts/secrets">
