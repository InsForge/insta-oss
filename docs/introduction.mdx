...
<CardGroup cols={3}>
  <Card title="MCP server" icon="plug" href="/agents/mcp-server">
    Drive the platform through `insta_*` tools.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="One credential seam" icon="key" href="/governance/overview">
...
The repository's [COMPATIBILITY.md](https://github.com/InsForge/insta-oss/blob/main/COMPATIBILITY.md) has the command-by-command list.
