...
| DELETE /projects/:id/services/:sid (every type) | gated service.remove | 200 `{ teardown: { destroyed, failed } }` counting containers, buckets and directories on the resolved branch (decision 50; today `{}` server.ts:628 and 501 for pg-/st- at 622-624); 404 | openapi.yaml:5430; platform server.ts:1761-1770; provisioning/services.ts:1022, 1091 | WP5 (all three delete paths) |
